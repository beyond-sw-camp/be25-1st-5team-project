...
### 🌱 이다윗
>  처음해본 DB 프로젝트이지만 같이 하는 프로젝트 팀원들과 같이하면서, 많이 배우고 도움이 되었습니다.
>  GITHUB를 통해 같이 프로젝트를 하는 법을 배우면서 주의사항들이나 어떻게 하는지에 대해 배우고, 많이 해봐야겠다 느꼈습니다.
>  MASTER/SLAVE 개념도 프로젝트를 하면서 처음 알게 되어서 배우는 과정에서 되게 즐거웠습니다.
>  팀원과 소통하면서 진행하는 과정에서 성장하는 것을 체감했습니다.
