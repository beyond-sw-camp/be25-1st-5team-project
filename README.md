...
>  덕분에 협업 과정에서 혼선이 적었고 전체적인 개발 흐름도 안정적으로 유지할 수 있었습니다.
>  또한 이번 프로젝트는 애플리케이션 서버 없이 오로지 DB만으로 서비스를 구현해본다는 새로운 관점의 도전이었는데, 이를 통해 실제 서비스 환경에서 데이터가 어떻게 관리되고 운영되는지에 대해 더 깊게 고민할 수 있었습니다.
